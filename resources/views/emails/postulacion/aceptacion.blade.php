        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="card mt-4 w-75">
                ...
                <div class="card-body border-0">
                    <h5 class="card-title">Estimado/a {{ $alumno->nombreCompleto() }},</h5>
                    <p>Esperamos que te encuentres muy bien. Nos complace informarte que haz sido aceptado para la vacante: </p>

                    <p>
                        • Título del puesto: {{ $vacante->nombre }} <br>
                        • Empresa: {{ $empresa->razon_social }} <br>
                        • Ubicación: [Ubicación de la Vacante] <br>
                        • Descripción: {{ $vacante->descripcion }}
                    </p>

                    <p>La empresa se pondra en contacto contigo para continuar con el proceso de seleccion</p>

                    <p>Agradecemos tu interés en ser parte de nuestra comunidad y te animamos a que
                        consideres registrarte nuevamente en el futuro si así lo deseas.</p>

                    <p>Lamentamos los inconvenientes y agradecemos tu comprensión.</p>

                    <p>Atentamente,<br>El Equipo de Talentía</p>

                    <p>Éste es un mensaje automático y no es necesario responder.</p>

                    <p><a href="#LINK">redes sociales</a></p>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <div>
                                            ¡Felicidades! Aceptación de tu Postulación para la Vacante
                                        </div>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        ...
                                        <div>
                                            Esperamos que te encuentres muy bien. Nos complace informarte que haz sido
                                            aceptado para la vacante:
                                        </div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                            ...
                                            <tr>
                                                <td class="center-text" align="center"
                                                    ...
                                                    <div>
                                                        La empresa se pondra en contacto contigo para continuar con el proceso de seleccion.
                                                    </div>
