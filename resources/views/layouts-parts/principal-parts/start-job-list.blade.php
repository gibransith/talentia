                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="recent-jobs" role="tabpanel"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-2 mb-md-0">
                                            <h5 class="fs-18 mb-1"><a href="job-details" class="text-dark">Web Developer</a>
                                            </h5>
                        ...
                        <div class="job-box bookmark-post card mt-4">
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-2 mb-md-0">
                                            <h5 class="fs-18 mb-1"><a href="job-details" class="text-dark">Business
                                                    Associate</a></h5>
                        ...
                        <div class="job-box bookmark-post card mt-4">
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-2 mb-md-0">
                                            <h5 class="fs-18 mb-1"><a href="job-details" class="text-dark">Digital Marketing
                                                    Manager</a></h5>
                        ...
                        <div class="job-box card mt-4">
                            ...
                            <div class="p-4">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-2 mb-md-0">
                                            <h5 class="fs-18 mb-1"><a href="job-details" class="text-dark">Product
                                                    Director</a></h5>
                        ...
                        <div class="text-center mt-4 pt-2">
                            <a href="job-list" class="btn btn-primary">View More <i class="uil uil-arrow-right"></i></a>
                        </div>
